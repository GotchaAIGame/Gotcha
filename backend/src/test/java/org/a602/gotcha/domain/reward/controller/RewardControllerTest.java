...
class RewardControllerTest {
    ...
    void setUp() {
        ...
        Reward reward1 = new Reward("리워드 1", 1, room, null);
        Reward reward2 = new Reward("리워드 2", 2, room, null);
        Reward reward3 = new Reward("리워드 3", 3, room, null);
        entityManager.persist(reward1);
        entityManager.persist(reward2);
        entityManager.persist(reward3);
...
//    }
    ...
    void removeRewardTest() throws Exception {
        ...
        assertEquals(removeBeforeSize - 3, removeAfterSize);
    }
