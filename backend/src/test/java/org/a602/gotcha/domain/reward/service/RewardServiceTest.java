...
public class RewardServiceTest {
    ...
    public void testSetReward() {
        ...
        when(s3Service.uploadImage("image1")).thenReturn("image1-url");
        when(s3Service.uploadImage("image2")).thenReturn("image2-url");
        ...
        verify(s3Service).uploadImage("image1");
        verify(s3Service).uploadImage("image2");
    ...
    public void testUpdateReward() {
        ...
        when(s3Service.uploadImage("Image 1")).thenReturn("New Image 1");
        when(s3Service.uploadImage("Image 2")).thenReturn("New Image 2");
        ...
        verify(s3Service, times(1)).uploadImage("Image 1");
        verify(s3Service, times(1)).uploadImage("Image 2");
